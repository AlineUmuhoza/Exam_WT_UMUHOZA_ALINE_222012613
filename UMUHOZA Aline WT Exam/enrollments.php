...
<section>
    ...
    <form method="post" onsubmit="return confirmInsert();">
        ...
        <label for="eid">enrollment_id:</label>
        ...
        <input type="date" id="enrd" name="enrd" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO enrollments(enrollment_id, id, course_id, enrollment_date) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $eid, $uid, $cid, $enrd);
      ...
      include('database_connection.php');
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $eid = $row['enrollment_id']; // Fetch the enrollment_id
                echo "<tr>
                    <td>" . $row['enrollment_id'] . "</td>
                    <td>" . $row['id'] . "</td>
                    <td>" . $row['course_id'] . "</td>
                    <td>" . $row['enrollment_date'] . "</td>
                    <td><a style='padding:4px' href='delete_enrollments.php?enrollment_id=$eid'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_enrollments.php?enrollment_id=$eid'>Update</a></td> 
                </tr>";
            }
        } else {
