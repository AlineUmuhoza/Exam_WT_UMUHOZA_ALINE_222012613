...
<body style="background-image: url('./images/product.jpg');background-repeat: no-repeat;background-size: cover;">

<div class="overlay">
  <div class="container">
    <h1 style="color: black;">Virtual Product Management Platform</h1>
